...
def sign_up():
	...
	if request.method == 'POST':
		...
		if not first_name or not last_name or not request.form['User_Role'] or not request.form['Gender'] or not request.form['Year'] or not contact_email or not password:
